...
module.exports = async r => {
  ...
  for (const w of r.wallets) {
    ...
    payload.attachments.push({
      author_name: w.name,
      author_icon: `https://www.bitsler.com/img/currencies/${symbols[w.name]}.png`,
      fallback: `${symbols[w.name].toUpperCase()} Status - ${w.version}`,
      text: `${symbols[w.name].toUpperCase()} Status - *${w.version}*`,
      fields: [{
        title: 'Container',
